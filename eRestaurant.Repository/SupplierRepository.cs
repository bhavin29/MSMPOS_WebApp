...
namespace RocketPOS.Repository
{
    public class SupplierRepository : ISupplierRepository
    {
        ...
        public List<SupplierModel> GetSupplierList()
        {
            ...
            {
                var query = "SELECT Id, SupplierName,TaxType,SupplierAddress1, SupplierAddress2,SupplierPhone,SupplierEmail,SupplierPicture,City, IsActive,Vat As VATNumber,Pin As PINNumber from Supplier WHERE IsDeleted = 0 " +
