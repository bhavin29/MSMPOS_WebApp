...
namespace RocketPOS.Repository
{
    public class UserRepository : IUserRepository
    {
        ...
        public List<UserModel> GetUserList()
        {
            ...
            {
                var query = "SELECT U.Id,(E.Lastname + ' ' + E.Firstname) as EmployeeName,EmployeeId,OutletId,Username,Password,ThumbToken,RollTypeId,LastLogin,LastLogout,IPAdress,Counter,U.IsActive "+
        ...
        public int InsertUser(UserModel UserModel)
        {
            ...
            using (SqlConnection con = new SqlConnection(_ConnectionString.Value.ConnectionString))
            {
                ...
                var query = "INSERT INTO [User] (EmployeeId,OutletId,Username,Password,ThumbToken,RollTypeId,IPAdress,Counter,IsActive) " +
                           "Values"+
                           "  (@EmployeeId,@OutletId,@Username,@Password,@ThumbToken,@RollTypeId,@IPAdress,@Counter,@IsActive); " +
        ...
        public int UpdateUser(UserModel UserModel)
        {
            ...
            using (SqlConnection con = new SqlConnection(_ConnectionString.Value.ConnectionString))
            {
                ...
                var query = "UPDATE [User] SET EmployeeId=@EmployeeId,OutletId=@OutletId,Username=@Username,Password=@Password,ThumbToken=@ThumbToken," +
                    "RollTypeId=@RollTypeId,IPAdress=@IPAdress,Counter=@Counter,IsActive=@IsActive " +
                     "WHERE Id = @Id;";
                result = con.Execute(query, UserModel, sqltrans, 0, System.Data.CommandType.Text);
