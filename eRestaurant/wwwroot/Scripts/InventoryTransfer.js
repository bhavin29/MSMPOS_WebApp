...
$('#addRow').on('click', function (e) {
    ...
    if (message == '') {
        ...
        InventoryTransferDatatable.row.add([
            $("#IngredientId").val(),
...
$(function () {
    $('#saveOrder').click(function () {
        if (!InventoryTransfer.data().any() || InventoryTransfer.data().row == null) {
            ...
            $("#InventoryTransfer").on("submit", function (e) {
                ...
                var data = ({
                    ...
                    EmployeeList: [],
                    IngredientList: [],
                    InventoryTransferDetails: dataArr
                });
...
function deleteOrder(purchaseId, ingredientId, rowId) {
    ...
    if (purchaseId == "0") {
        ...
        $.when(deleteOrderItem(InventoryTransferId).then(function (res) {
            console.log(res)
            if (res.status == 200) {
                debugger;
                for (var i = 0; i < dataArr.length; i++) {
