...
$('#addRow').on('click', function (e) {
    ...
    if (message == '') {
        ...
        var rowNode = WasteDatatable.row.add([
            ...
            '<td>' + $("#WasteId").val() + '</td>',
            '<td><div class="form-button-action"><a href="#" class="btn btn-link btn-danger" data-toggle="modal" data-target="#myModal' + myModal + '">Delete</a></div></td > ' +
        ...
        dataArr.push({
            wasteIngredientId: $("#WasteIngredientId").val(),
